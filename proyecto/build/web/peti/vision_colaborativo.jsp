...
<body>
    ...
    <div class="nav-section">
        ...
        <ul>
            ...
            <li class="active"><a href="vision_colaborativo.jsp<%= modoColaborativo ? "?modo=colaborativo&grupo=" + grupoActual + "&rol=" + rolUsuario : "?modo=individual" %>"><i class="fas fa-eye"></i> Visión Estratégica</a></li>
    ...
    <div class="nav-section">
        ...
        <ul>
            ...
            <li><a href="autodiagnostico_BCG.jsp<%= modoColaborativo ? "?modo=colaborativo&grupo=" + grupoActual + "&rol=" + rolUsuario : "?modo=individual" %>"><i class="fas fa-users"></i> autodiagnostico_BCG</a></li>
            
            <%-- Enlaces faltantes agregados (Matriz/Análisis de Porter, PEST, Estrategias, CAME) --%>
