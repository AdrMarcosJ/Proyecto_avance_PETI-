...
<body>
    ...
    <div class="nav-section">
        ...
        <ul>
            ...
            <li class="active"><a href="valores_colaborativo.jsp<%= modoColaborativo ? "?modo=colaborativo&grupo=" + grupoActual + "&rol=" + rolUsuario : "?modo=individual" %>"><i class="fas fa-heart"></i> Valores Organizacionales</a></li>
    ...
    <div class="nav-section">
        ...
        <ul>
            <%-- Enlaces corregidos y agregados --%>
