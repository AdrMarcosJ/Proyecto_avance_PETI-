    ...
    <body>
        ...
        <div class="main-container">
            <% if (grupoActual == null) { %>
                ...
                <div class="card">
                    <h3>📊 Sistema PETI</h3>
                    <p>Accede al sistema de Planificación Estratégica de Tecnologías de Información. <strong>Nota:</strong> Necesitas estar en un grupo para acceder a todas las funcionalidades.</p>
                    
                    <a href="peti/dashboard.jsp?modo=individual" class="btn btn-info" style="margin-bottom: 1rem;">
                        🚀 Explorar Sistema PETI (Modo Individual)
                    </a>
                    <p style="font-size: 0.9rem; color: #666; margin-top: 0.5rem;">
                        <i class="fas fa-info-circle"></i> Únete a un grupo para trabajar colaborativamente
                    </p>
                </div>
            <% } else { %>
                ...
                <div class="card">
                    <h3>📊 Sistema PETI</h3>
                    <p>Accede al sistema de Planificación Estratégica de Tecnologías de Información para tu grupo.</p>
                    
                    <a href="peti/dashboard.jsp?modo=colaborativo&grupo=<%= grupoActual %>&rol=<%= rolUsuario %>" class="btn btn-primary" style="margin-bottom: 1rem;">
                        🚀 Acceder al Sistema PETI (Modo Colaborativo)
                    </a>
                    <p style="font-size: 0.9rem; color: #666; margin-top: 0.5rem;">
                        <i class="fas fa-users"></i> Trabajando con tu grupo: <strong><%= grupoActual %></strong>
                    </p>
                    
                    <% if ("admin".equals(rolUsuario)) { %>
                        <div style="margin-top: 1rem; padding: 0.75rem; background: #fff3cd; border-radius: 8px; border-left: 4px solid #ffc107;">
                            <small><i class="fas fa-crown"></i> <strong>Administrador:</strong> Puedes gestionar permisos y ver el progreso de todos los miembros</small>
                        </div>
                    <% } else { %>
                        <div style="margin-top: 1rem; padding: 0.75rem; background: #d1ecf1; border-radius: 8px; border-left: 4px solid #17a2b8;">
                            <small><i class="fas fa-user-friends"></i> <strong>Miembro:</strong> Puedes editar y colaborar en tiempo real con tu equipo</small>
                        </div>
                    <% } %>
                </div>
