...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!currentUser && !window.location.href.includes('index.html') && !window.location.href.includes('registro.html')) {
...
function setupPlanLinks() {
    ...
    if (planNavContainer) {
        ...
        planSections.forEach(section => {
            ...
            li.innerHTML = `<a href="${section.id}.html"><i class="fas ${section.icon}"></i> ${section.name}</a>`;
...
function updateBreadcrumb(planSections) {
    ...
    let breadcrumbHTML = '<li><a href="dashboard.html"><i class="fas fa-home"></i> Inicio</a></li>';
