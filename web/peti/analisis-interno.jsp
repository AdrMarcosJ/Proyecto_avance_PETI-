...
<head>
    ...
    <title>Análisis Interno (FODA) - Plan Estratégico</title>
...
<body>
        ...
        <div class="dashboard-sidebar">
            ...
            <nav class="dashboard-nav">
                <ul>
                    ...
                    <li class="active"><a href="analisis-interno.jsp"><i class="fas fa-chart-bar"></i> Análisis Interno</a></li>
        ...
        <div class="dashboard-content">
            ...
            <main class="dashboard-main">
                <div class="analysis-section">
                    ...
                    <p>Identifica las fortalezas y debilidades internas de la organización.</p>
                    
                    <div class="foda-grid">
                        <div class="foda-card fortalezas">
                            <h3><i class="fas fa-thumbs-up"></i> Fortalezas</h3>
                            <div class="form-group">
                                <textarea id="fortalezas" placeholder="Describe las fortalezas internas de la organización..."></textarea>
                            </div>
                        </div>
                        ...
                        <div class="foda-card debilidades">
                            ...
                            <div class="form-group">
                                <textarea id="debilidades" placeholder="Describe las debilidades internas de la organización..."></textarea>
                            </div>
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label for="conclusion">Conclusiones del Análisis Interno:</label>
                        <textarea id="conclusion" placeholder="Resume las principales conclusiones del análisis interno..."></textarea>
                    </div>
    ...
    <script>
        ...
        function guardarAnalisis() {
            ...
            if (!fortalezas.trim() || !debilidades.trim()) {
                alert('Por favor, complete todos los campos obligatorios.');
                return;
            }
            
            // Aquí se puede agregar la lógica para guardar en la base de datos
            alert('Análisis interno guardado exitosamente.');
        }
