...
<head>
    ...
    <title>Análisis Externo (FODA) - Plan Estratégico</title>
    ...
    <style>
        * {
        ...
        .foda-card.fortalezas h3 {
            color: #28a745;
        }

        .foda-card.oportunidades h3 {
            color: #007bff;
        }

        .foda-card.debilidades h3 {
            color: #ffc107;
        }

        .foda-card.amenazas h3 {
            color: #dc3545;
        }
        ...
        .foda-card.fortalezas .foda-list li:before {
            color: #28a745;
        }

        .foda-card.oportunidades .foda-list li:before {
            color: #007bff;
        }

        .foda-card.debilidades .foda-list li:before {
            color: #ffc107;
        }

        .foda-card.amenazas .foda-list li:before {
            color: #dc3545;
        }

        .foda-list li:last-child {
            border-bottom: none;
        }
...
<body>
        ...
        <div class="dashboard-sidebar">
            ...
            <nav class="dashboard-nav">
                <ul>
                    ...
                    <li class="active"><a href="analisis-externo.jsp"><i class="fas fa-search"></i> Análisis Externo</a></li>
        ...
        <div class="dashboard-content">
            ...
            <main class="dashboard-main">
                <div class="analysis-section">
                    <h2>Análisis FODA - Factores Externos</h2>
                    <p>Identifica las oportunidades y amenazas del entorno externo que pueden afectar a la organización.</p>
                    
                    <div class="foda-grid">
                        <div class="foda-card oportunidades">
                            <h3><i class="fas fa-arrow-up"></i> Oportunidades</h3>
                            <div class="form-group">
                                <textarea id="oportunidades" placeholder="Describe las oportunidades del entorno externo..."></textarea>
                            </div>
                        </div>
                        ...
                        <div class="foda-card amenazas">
                            ...
                            <div class="form-group">
                                <textarea id="amenazas" placeholder="Describe las amenazas del entorno externo..."></textarea>
                            </div>
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label for="conclusion">Conclusiones del Análisis Externo:</label>
                        <textarea id="conclusion" placeholder="Resume las principales conclusiones del análisis externo..."></textarea>
                    </div>
    ...
    <script>
        ...
        function guardarAnalisis() {
            ...
            if (!oportunidades.trim() || !amenazas.trim()) {
                alert('Por favor, complete todos los campos obligatorios.');
                return;
            }
            
            // Aquí se puede agregar la lógica para guardar en la base de datos
            alert('Análisis externo guardado exitosamente.');
        }
