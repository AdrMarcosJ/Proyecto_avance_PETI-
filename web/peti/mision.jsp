        ...
        <div class="dashboard-content">
            <header class="dashboard-header">
                ...
                <div class="header-actions">
                    <button class="btn-primary" onclick="guardarMision()"><i class="fas fa-save"></i> Guardar</button>
                </div>
            </header>
            <main class="dashboard-main">
                <div class="mission-section">
                    ...
                    <div class="form-group">
                        <label for="mision">Declaración de la Misión:</label>
                        <textarea id="mision" placeholder="Redacte la misión de su empresa de manera clara y concisa..." oninput="actualizarPreview()"></textarea>
                    </div>
                    
                    <div class="mission-preview">
                        <h3>Vista Previa de la Misión:</h3>
                        <p id="misionPreview">La misión aparecerá aquí mientras la escribes...</p>
                    </div>
